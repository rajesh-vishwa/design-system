...
export interface TButtonProps {
  ...
  buttonStyle?: 'primary' | 'secondary' | 'primary-wrappingtext' | 'secondary-wrappingtext' | 'secondary-tiny-wrappingtext' | 'tertiary' | 'controlText' ;
  disabled?: boolean;
  size?: 'large' | 'small';
}
...
const Button: React.FC<TButtonProps> = (props) => {
  ...
  const primary = buttonStyle === 'primary' || buttonStyle === 'primary-wrappingtext';
